...
var totalVotes = new Firebase('https://mwymi.firebaseio.com/Battles/'+battleName+'/totalLeftVotes');
...
*/
  ...
  header("Location: " . urldecode($failEncoded)); /* Redirect browser */
exit();
}
